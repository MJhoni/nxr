...
import HeaderNxrmalE from '@/components/HeaderNxrmalE.vue'
import FooterNxrmalE from '@/components/FooterNxrmalE.vue'
import RelatedNxrmalE from '@/components/RelatedNxrmalE.vue';
...
export default {
  ...
  data() {
      return {
          gambar_default: "img/products/aespa 1.jfif",
          thumbs: [
                "img/products/aespa 1.jfif",
                "img/products/aespa 2.jfif",
                "img/products/aespa 3.jfif",
                "img/products/aespa 4.png"                
          ]
      }
  },
  methods: {
